...
class MyWebDashboard extends StatefulWidget {
  const MyWebDashboard({Key? key}) : super(key: key);

  @override
  State<MyWebDashboard> createState() => _MyWebDashboard();
}
...
// For web
class _MyWebDashboard extends State<MyWebDashboard> {
...
class TaskCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    return Container(
      width: screenWidth * 0.20, // Adjust the card width as needed
